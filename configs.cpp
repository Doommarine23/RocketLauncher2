...
void RocketLauncher2::applyConfig(RocketFile *rocket)
{
    ...
    {
        if(enginelist->getCurrentEngine()->type != Engine_Turok1 && enginelist->getCurrentEngine()->type != Engine_Turok2 && enginelist->getCurrentEngine()->type != Engine_Doom64EX)  //REQUIRED to prevent needless warnings. Make this a better system someday.
